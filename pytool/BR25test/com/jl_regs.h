...
#define AUDIO_DAC_DPD			0x3C
#define AUDIO_DAC_COP			0x40
#define AUDIO_ADC_CON			0x44	// adc control
#define AUDIO_ADC_ADR			0x48	// adc data address
#define AUDIO_ADC_LEN			0x4C	// adc data length
#define AUDIO_ADC_PNS			0x50
#define AUDIO_ADC_HWP			0x54
#define AUDIO_ADC_SRP			0x58
#define AUDIO_ADC_SRN			0x5C
